            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <?= $form1->field($transaksiModel, 'id_pelanggan')->label('Customer')->dropDownList(
                                ['' => 'Choose Customers'] + \yii\helpers\ArrayHelper::map(\app\models\TbPelanggan::find()->all(), 'id_pelanggan', 'nama_lengkap')
                            ) ?>
                        </div>
                        <div class="col-md-4">
                            <?= $form1->field($transaksiModel, 'tanggal')->label('Date')->textInput(['type' => 'date']) ?>
                        </div>
                        <div class="col-md-4">
                            <?= $form1->field($transaksiModel, 'id')->label('Staff')->dropDownList(
                                ['' => 'Choose Staff'] + \yii\helpers\ArrayHelper::map(\app\models\Login::find()->all(), 'id', 'nama')
                            ) ?>
                        </div>
                        <?php ActiveForm::end(); ?>
                        <hr>
                        ...
                        <div class="col-md-7">
                            <?= $form2->field($detailTransaksiModel, 'id_produk')->label('Product')->dropDownList(
                                ['' => 'Choose Product'] + \yii\helpers\ArrayHelper::map(\app\models\Tbbarang::find()->all(), 'id_produk', 'nama_produk')
                            ) ?>
                        </div>
                        <div class="col-md-5">
                            <?= $form2->field($detailTransaksiModel, 'jumlah_produk')->textInput() ?>
                        </div>
                        <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between">
                <div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($detailTransaksiData as $index => $item) : ?>
                                <tr>
                                    <td><?= $index + 1 ?></td>
                                    ...
                                    <td>
                                        <?= \yii\helpers\Html::a('Delete', ['delete', 'id' => $item->id_detail], [
